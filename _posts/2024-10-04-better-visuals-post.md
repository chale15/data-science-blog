...
<p class="tip-description">
Simple visualizations like these help us to see trends and identify relationships, providing a foundation that we can build off of with plotnine. </p>
...
<p class="tip-description">
    Highlight key insights directly through annotations, emphasis, or the use of color, keeping the overall design clean and focused.  </p>
